...
class HMW_Classes_Tools extends HMW_Classes_FrontController {
    ...
    public function hookActionlink($links, $file) {
        if ($file == _HMW_PLUGIN_NAME_ . '/index.php') {
            $link = '<a href="' . admin_url('admin.php?page=hmw_settings') . '">' . __('Settings', _HMW_PLUGIN_NAME_) . '</a>';
    ...
    public static function sendEmail() {
        ...
        $message .= "Need Advanced Security Protection? Save up to $100 TODAY! Use coupon HMWUW16 for Unlimited Websites" . "\n";

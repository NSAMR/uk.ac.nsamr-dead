...
function hmw_showError() {
    echo '<div class="update-nag"><span style="color:red; font-weight:bold;">' . __('For Hide My Wordpress to work, the PHP version has to be equal or greater then 5.1', _HMW_PLUGIN_NAME_) . '</span></div>';
}

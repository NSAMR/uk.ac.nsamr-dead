...
class HMW_Controllers_Notice extends HMW_Classes_FrontController {
    ...
    public function hmw_admin_notices($notices) {
        ...
        $one_week_support = add_query_arg( array( 'hmw_admin_notice' => 'one_week_support', 'hmw_admin_notice_action' => 'disable' ) );
        $notices['one_week_support'] = array(
            'title' => __( "Hey! How's It Going?", _HMW_PLUGIN_NAME_ ),
            'msg' => __( "Thank you for using Hide My WP! We hope that you've found it useful for your wesite, but if you have any questions:", _HMW_PLUGIN_NAME_ ),
            'link' => '<li><span class="dashicons dashicons-media-text"></span><a target="_blank" href="http://wpplugins.tips/cat/how-to/">' . __( 'Check out the How To Section', _HMW_PLUGIN_NAME_ ) . '</a></li>
                    <li><span class="dashicons dashicons-email"></span><a target="_blank" href="http://wpplugins.tips/contact-us/">' . __( 'Contact us' ,_HMW_PLUGIN_NAME_ ) . '</a></li>
                    <li><span class="dashicons dashicons-dismiss"></span><a href="' . $one_week_support . '">' . __( 'Never show again' ,_HMW_PLUGIN_NAME_) . '</a></li>',
            'int' => 7
        );

<?php
//Template Name: Portfolio Fullwidth 3
get_header();
...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="portfolio-box portfolio-wrap col-3-no-space">
            <?php
                    ...
                    <div id="post-<?php the_ID(); ?>" <?php post_class(array('project-post', $cat_slugs)); ?>>
                        <div class="img-icon">
                            ...
                            <div class="img-icon-overlay">
                                <p>
                                    <a href="<?php echo $big_image_url; ?>" class="show-image"><i class="fa fa-eye"></i></a>
                                    <a href="<?php the_permalink(); ?>"><i class="fa fa-sliders"></i></a>
                                </p>
                            </div>
                        </div>
                    </div>

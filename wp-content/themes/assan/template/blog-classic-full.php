        ...
        <div <?php echo $content_class; ?>>
            ...
            if ($wp_query->have_posts()) :
                while ($wp_query->have_posts()) : $wp_query->the_post();
                    ?>
                    <div id="post-<?php the_ID(); ?>" <?php post_class(array('wow', 'fadeInUp')); ?>>
                        <div class="blog-post">
                            <a href="<?php the_permalink(); ?>">
                                <div class="item-img-wrap">
                                    <?php the_post_thumbnail('assan-fullwidth', array('class' => 'img-responsive')); ?>
                            ...
                            <ul class="list-inline post-detail">
                                <?php crazy_assan_full_posted_on(); ?>
                            </ul>

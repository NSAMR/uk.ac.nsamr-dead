...
<html <?php language_attributes(); ?>>
    ...
    <body <?php body_class('coming-soon-full'); ?>>
        <?php
        ...
        ?>
        <div class="wrapper">
            <div class="coming-soon-fullscreen" style="background: url('<?php echo $hero_image; ?>');background-attachment: fixed;background-size: cover;" data-stellar-background-ratio="0.5">
                <div class="v-middle">
                    <div class="container">
                        <div class="row">

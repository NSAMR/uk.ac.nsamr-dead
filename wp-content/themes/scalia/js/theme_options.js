(function($) {
	$(document).ready(function() {
		...
		function scalia_updateAdminFonts(root) {
			var fonts = [];
		...
		$('.font-select select').each(function() {
			...
			$this.change(function(e) {
				scalia_updateAdminFonts($(this).closest('.font-select'));
			});
		});

		scalia_updateAdminFonts($('.font-select'));
		...
		var skins_defaults = JSON.parse(theme_options_object.scalia_color_skin_defaults);

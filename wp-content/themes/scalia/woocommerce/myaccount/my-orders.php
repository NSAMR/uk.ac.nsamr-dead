...
if ( $customer_orders ) : ?>
	...
	<div class="sc-table"><table class="shop_table my_account_orders">
						...
						<?php
							...
							if ($actions) {
								foreach ( $actions as $key => $action ) {
									echo '<a href="' . esc_url( $action['url'] ) . '" class="sc-button ' . sanitize_html_class( $key ) . '">' . esc_html( $action['name'] ) . '</a>';
								}
							}
						?>
					</td>

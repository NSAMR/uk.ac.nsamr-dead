			...
			<div class="item-post">
				<?php if (has_post_thumbnail()) : ?>
					<div class="post-image col-md-3">
						<?php scalia_post_thumbnail('medium', false, 'img-responsive'); ?>
					</div>
				<?php endif; ?>
				<div class="post-text col-md-<?php echo has_post_thumbnail() ? 9 : 12; ?>">
					<header class="entry-header">

						<?php if (in_array('category', get_object_taxonomies(get_post_type())) && scalia_categorized_blog()) : ?>
					...
					<?php else : ?>
						<div class="entry-content">
							<?php
							the_content(__('Continue reading <span class="meta-nav">&rarr;</span>', 'scalia'));
							wp_link_pages(array(

...
if($this->getShortcode() == 'vc_tta_tabs' || $this->getShortcode() == 'vc_tta_tour'){
	if($atts['style'] == 'scalia-style-1' || $atts['style'] == 'scalia-style-2') {
		$atts = vc_map_get_attributes( $this->getShortcode(), array(
			'style' => $atts['style'],
			'shape' => $atts['shape'],
